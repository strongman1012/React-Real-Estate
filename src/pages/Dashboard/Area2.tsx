...
import { fetchAreas, deleteAreaById } from '../../reducers/area2/area2Slice';
...
import EditArea2 from 'src/components/Dashboard/area-2/EditArea2';
import NewArea2 from 'src/components/Dashboard/area-2/NewArea2';
...
const onExporting = (e: DataGridTypes.ExportingEvent) => {
    ...
    const worksheet = workbook.addWorksheet('Area2');
    ...
    exportDataGrid({
        ...
        workbook.xlsx.writeBuffer().then((buffer) => {
            saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Area2.xlsx');
        });
    });
};
...
const Area2: FC = () => {
    ...
    const areas = useSelector((state: RootState) => state.area2.allAreas);
    ...
    return (
        <Container maxWidth={false}>
                ...
                <Card variant="outlined">
                    ...
                    <CardContent>
                        ...
                        >
                            ...
                            <Column dataField='subject' caption='Subject' allowHiding={false} />
                            <Column dataField='content' caption='Content' allowHiding={false} />
            ...
            <Drawer
                ...
                onOpen={() => { }}>
                {
                    modalType === "new" ? <NewArea2 onClose={() => setEditModalOpen(false)} /> : <EditArea2 areaId={selectedAreaId as number} onClose={() => setEditModalOpen(false)} />
                }
            </Drawer>
